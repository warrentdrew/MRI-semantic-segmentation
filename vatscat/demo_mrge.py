...
for i in range(4):
    ...
    print('training length:', len(train_path))
    ...
    path_w = args.model_path + "k-fold-mrge-512-pos" + str(i) + ".hdf5"
    ...
    '''
    # resume training
    model_path = '/home/d1251/no_backup/d1251/models/k-fold-mrge-weights-pos0.hdf5'
    hist_object = network.resume(patients_train, patients_val_slices, checkpointer, args, init_epoch= 2, model_path = model_path)
    ...
    # save history
    path_hist = args.history_path + "k-fold-mrge-512-pos"
