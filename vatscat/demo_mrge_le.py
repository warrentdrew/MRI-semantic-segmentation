...
for i in range(4):
    ...
    train_path, validation_path, test_path = dataset_split(patients_path_list, k, i, incl_rate = 0.3)
    ...
    network = MRGE_LE(in_shape=(args.in_size, args.in_size, args.in_size, 1),
                      rls = args.rls,
                      k_0 = args.k_0,
                      lbda = args.lbda,
    ...
    path_w = args.model_path + "k-fold-mrge-le-weights" + str(i) + ".hdf5"
    ...
    # save history
    path_hist = args.history_path + "k-fold-mrge-le"
